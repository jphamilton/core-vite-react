...
namespace Services.Telemetry
{
    ...
    // In real life, imagine this is a MassTransit Consumer connected to RabbitMQ or something similar
    public class TelemetryGateway : ITelemetryGateway
    {
        ...
        {
            private List<IObserver<TelemetryData[]>> _observers;
            private IObserver<TelemetryData[]> _observer;
